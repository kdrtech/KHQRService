...
if [ ! -f apikhqr.js ]; then
  echo "Error: apikhqr.js not found!"
  exit 1
fi
...
javascript-obfuscator dist/APIKhqrSDK.min.js --output dist/APIKhqrSDK.js --compact true --control-flow-flattening true
